...
,   faye    = require('faye')
,   store   = require('models/stores/couchdb')
,   tiles   = require('models/tile_cacher')
;
...
MapSketcher.prototype.init = function() {
  ...
  self.app.get('/tiles/:zoom/:x/:y.png', function(req,res) {
    tiles.get(res, {
      x: req.params.x
    , y: req.params.y
  ...
  self.app.get('/rooms/:room/sketches.json', function(req,res) {
    ...
    store.get(req.params.room, function(sketches) {
